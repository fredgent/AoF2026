...
We plan to implement groundbreaking coupled multi-tiered, or {\textit{extended
...
this innovative concept shall be applied to dust, but our new interactive
control tools would have applicability in other disciplines proliferated by
...
disciplines, with increased overheads. Our approach will use multi-grid tools
to extend the scales and physics accessible to the hierarchy of simulations
